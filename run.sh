...
# ./cvp -v -t 2 ${trace_sketch} > ${dir}/${tag_sketch}_predict_winner2018.log

#mjpeg
# ./cvp ${trace_mjpeg} > ${dir}/${tag_mjpeg}_base.log
# ./cvp -v -p -t 2 ${trace_mjpeg} > ${dir}/${tag_mjpeg}_perfect.log
# ./cvp -v -t 2 ${trace_mjpeg} > ${dir}/${tag_mjpeg}_predict_winner2018.log

#Lane detection
# ./cvp ${trace_lane} > ${dir}/${tag_lane}_base.log
# ./cvp -v -p -t 2 ${trace_lane} > ${dir}/${tag_lane}_perfect.log
# ./cvp -v -t 2 ${trace_lane} > ${dir}/${tag_lane}_predict_winner2018.log